    ...
    starlight({
      ...
      sidebar: [
        ...
        },
        {
          label: 'The Flow',
          items: [
            { label: 'Overview', slug: 'stages' },
            { label: 'Pre-Flight', slug: 'stages/pre-flight' },
            { label: 'Collect Inputs', slug: 'stages/collect-inputs' },
            { label: 'Claude Agent', slug: 'stages/claude-agent' },
            { label: 'Execute Outputs', slug: 'stages/execute-outputs' },
            { label: 'Report Results', slug: 'stages/report-results' },
            { label: 'Audit Report', slug: 'stages/audit-report' },
          ],
        },
        {
